...
keymap("n", "<S-Left>", ":bprevious<CR>", { desc = "Onglet précédent" })
keymap("n", "<S-Right>", ":bnext<CR>", { desc = "Onglet suivant" })

-- nouvelles touches directionnelles : jklm
--keymap('n', '<Up>', 'k', { desc = "Flèche du haut", noremap = true, silent = true })
--keymap('n', '<Down>', 'l', { desc = "Flèche du bas", noremap = true, silent = true })
--keymap('n', '<Left>', 'j', { desc = "Flèche de gauche", noremap = true, silent = true })
--keymap('n', '<Right>', 'm', { desc = "Flèche de droite", noremap = true, silent = true })
